...
const STATIC_NAV: Array<{ slug: string; label: string; hint: string }> = [
  ...
  { slug: '/about',       label: 'About · how it works',    hint: 'how verification works' },
  { slug: '/use-cases',   label: 'Use cases',                hint: 'who uses this and how' },
  ...
  { slug: '/health',      label: 'Citation health',          hint: 'upstream URL probes' },
