...
const CLASS_RULES: { slug: string; label: string; prefixes: string[] }[] = [
  ...
  { slug: 'antibiotics', label: 'Antibiotics', prefixes: ['J01', 'P01AB', 'J04'] },
  { slug: 'antifungals', label: 'Antifungals', prefixes: ['J02', 'D01'] },
  { slug: 'antiparasitics', label: 'Antiparasitics', prefixes: ['P02', 'P51', 'P53', 'P54', 'P01B'] },
  ...
  { slug: 'diabetes', label: 'Diabetes & glucose regulation', prefixes: ['A10', 'H04'] },
  { slug: 'hematology', label: 'Hematology', prefixes: ['B01', 'B02A'] },
  { slug: 'antidotes', label: 'Antidotes', prefixes: ['V03', 'B02BA', 'M01CC'] },
  { slug: 'muscle-relaxants', label: 'Muscle relaxants', prefixes: ['M03'] },
  { slug: 'immunomodulators', label: 'Immunomodulators', prefixes: ['L04', 'L03'] },
  { slug: 'cns-psychotropic', label: 'CNS / psychotropic', prefixes: ['N06', 'N04BB', 'N04BD'] },
  ...
  { slug: 'topical-corticosteroids', label: 'Topical corticosteroids', prefixes: ['D07'] },
